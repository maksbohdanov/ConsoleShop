...
using Store.ConsoleApp.FormatExtensions;
using Ninject;
...
namespace Store.ConsoleApp
{
    public class Controller
    {
        ...
        public Controller(IOrderService orderService, IProductService productService, IUserService userService)
        {
        ...
        {
            StoreClient.UserId = null;
            StoreClient.UserType = "Guest";
        ...
        public string LogIn()
        {
            ...
            try
            {
                ...
                StoreClient.UserId = user.Id;
                StoreClient.UserType = user.UserType;
                return "\nYou are logged in.";
            }
        ...
        public string AddToOrder()
        {
            ...
            try
            {
                ...
                var result = _userService.AddToOrder(StoreClient.UserId, name, amount);
        ...
        public string CancelOrder()
        {
            try
            {
                var result = _userService.CancelOrder(StoreClient.UserId);
        ...
        public string ReceiveOrder()
        {
            try
            {
                var result = _userService.ReceiveOrder(StoreClient.UserId);
        ...
        public string CreateOrder()
        {
            try
            {                
                var result = _userService.AddNewOrder(StoreClient.UserId);
        ...
        public string ViewAllOrders()
        {
            try
            {
                var orders = _userService.GetUserOrders(StoreClient.UserId);
        ...
        public string ChangePersonalInfo()
        {
            ...
            try
            {
                var result = _userService.ChangeUser(StoreClient.UserId, userModel);
